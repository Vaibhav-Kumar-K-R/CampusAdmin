...
router.get(
  "/section/:sectionId/course/:courseId/faculty/:facultyId/date/:date",
  authenticateJWT,
  getAttendanceBySectionAndDate,
);

router.get(
  "/check/:sectionId/course/:courseId/faculty/:facultyId/date/:date",
  authenticateJWT,
  checkAttendanceExists,
);
...
router.get(
  "/history/:sectionId/course/:courseId/faculty/:facultyId",
  authenticateJWT,
  getAttendanceHistory,
);

router.get(
  "/is-marked/:sectionId/section/:courseId/course/:facultyId/faculty",
  authenticateJWT,
  isAttendanceMarked,
);

  ...
  useEffect(() => {
    const getAttendanceForDate = async () => {
      ...
      try {
        ...
        const data = await fetchAttendanceByDate(
          studentData._id,
          formattedDate,
        );
    ...
    >
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Present: {attendanceData?.present || 0} days | Absent:{" "}
                    {attendanceData?.absent || 0} days
                  </p>
                </div>
              ...
              <CardContent className="pt-0">
                ...
                <div className="mt-2">
                  <Badge
                    ...
                    variant={
                      course.percentage >= 75 ? "success" : "destructive"
                    }
                  >
                    {course.percentage >= 75
                      ? "Good Standing"
      ...
      <motion.div variants={itemVariants}>
        <Tabs
          ...
          onValueChange={setAttendanceView}
          className="w-full"
        >
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-7/12">
                    ...
                    <Calendar
                      ...
                      modifiersClassNames={{
                        present:
                          "bg-green-500 hover:text-white hover:bg-green-800 text-white font-medium",
                        absent:
                          "bg-red-500 hover:text-white hover:bg-red-800 text-white font-medium",
                        selected:
                          "bg-yellow-600 hover:text-white hover:bg-yellow-800 text-white font-medium",
                      }}
                              ...
                              >
                                ...
                                <div className="flex items-center">
                                  ...
                                  <Badge
                                    ...
                                    className="flex items-center bg-[#048c7f] text-white hover:text-white hover:bg-[#53033c]"
                                  >
                                    {attendance.status === "Present" ? (
                                      <>
          ...
          <TabsContent value="courses" className="m-0">
            <Card className="border-none shadow-md">
              <CardHeader>
                ...
                <CardDescription>
                  Your attendance breakdown by course
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="trends" className="m-0">
            <Card className="border-none shadow-md">
              <CardHeader>
                ...
                <CardDescription>
                  Track your attendance patterns over time
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-[400px]">

          ...
          <Card className="border-none shadow-md hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <div className="text-sm text-gray-600">
                ...
                <p>
                  {studentData.sectionId?.courseFacultyMappings?.length || 0}{" "}
                  Courses
                </p>
              </div>
            </CardContent>
        ...
        <motion.div variants={itemVariants}>
          <Card className="border-none shadow-md hover:shadow-lg transition-shadow h-full">
            <CardHeader>
              ...
              <CardDescription>
                Overall grade distribution across courses
              </CardDescription>
            </CardHeader>
      ...
      <motion.div variants={itemVariants}>
        <Card className="border-none shadow-md hover:shadow-lg transition-shadow">
          <CardHeader>
            ...
            <CardDescription>
              Your performance compared to section average
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-md">
              ...
              <p className="text-sm text-blue-700">
                {comparisonData.filter(
                  (item) => item.yourScore > item.sectionAverage,
                ).length >
                comparisonData.filter(
                  (item) => item.yourScore < item.sectionAverage,
                ).length
      ...
      <motion.div variants={itemVariants}>
        <Card className="border-none shadow-md hover:shadow-lg transition-shadow">
          <CardHeader>
            ...
            <CardDescription>
              Your progress in current semester courses
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              {courseProgress.map((course, index) => (
                ...
                >
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <Badge
                      variant={course.completed >= 70 ? "success" : "default"}
                    >
                      {course.completed}%
                    </Badge>
                  </div>
      ...
      <motion.div variants={itemVariants}>
        <Card className="border-none shadow-md hover:shadow-lg transition-shadow">
          <CardHeader>
            ...
            <CardDescription>
              Your performance trend compared to section average
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-[300px] w-full">

  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-50 p-4">
      ...
      <div className="fixed top-4 left-4">
        <button
          onClick={() => navigate("/")}
          className="flex items-center justify-center p-2 rounded-full bg-white shadow-md hover:bg-gray-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#048c7f]"
      ...
      >
        ...
        >
          <h2 className="text-2xl text-left text-gray-800 mb-6 font-extrabold">
            Admin Registration
          </h2>
                      ...
                      <p className="mt-1 text-sm text-gray-500">
                        {formData.email.endsWith(
                          ...
                          <span className="text-green-600 flex items-center">
                            <Check className="h-4 w-4 mr-1" /> Email matches
                            institution domain
                          </span>
                        ) : (
                          <span className="text-amber-600 flex items-center">
                            <AlertCircle className="h-4 w-4 mr-1" /> Email must
                            end with @{formData.institutionDomain}
                          </span>
                        )}
                      </p>
                    )}
                  ...
                  {formData.password && !errors.password && (
                    <div className="mt-1">
                      <div className="flex items-center mb-1">
                        <div
                          className={`h-1 ${formData.password.length >= 8 ? "bg-green-500" : "bg-gray-300"} rounded w-1/4 mr-1`}
                        ></div>
                        <div
                          className={`h-1 ${formData.password.length >= 10 ? "bg-green-500" : "bg-gray-300"} rounded w-1/4 mr-1`}
                        ></div>
                        <div
                          className={`h-1 ${formData.password.length >= 12 ? "bg-green-500" : "bg-gray-300"} rounded w-1/4 mr-1`}
                        ></div>
                        <div
                          className={`h-1 ${formData.password.length >= 14 ? "bg-green-500" : "bg-gray-300"} rounded w-1/4`}
                        ></div>
                      </div>
      ...
      ${isSubmitting ? "bg-[#8a1d65]" : "bg-[#048c7f] hover:bg-[#500f3b]"} 

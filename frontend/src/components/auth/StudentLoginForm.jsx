...
const StudentLoginForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${apiUrl}/api/student/login`, {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <motion.div className="mb-4" variants={itemVariants}>
              <div className="flex justify-between items-baseline">
                ...
                <button
                  ...
                  className="text-xs text-[#048c7f] hover:text-[#8a1d65] transition-colors duration-200 font-medium"
                >
                  Forgot password?
                </button>
              </div>
            ...
            >
              <input
                ...
                className="h-4 w-4 text-[#048c7f] focus:ring-[#8a1d65] border-gray-300 rounded"
              />
              <label
                htmlFor="rememberMe"

    ...
    const fetchFacultyData = async () => {
      try {
        ...
        const sectionsResponse = await axios.get(
          `${apiUrl}/api/faculty/${user._id}/sections`,
          config,
        );
        ...
        const semestersResponse = await axios.get(
          `${apiUrl}/api/faculty/${user._id}/semesters`,
          config,
        );
          ...
          >
            ...
            <div className="flex gap-3 pr-4 flex-wrap">
              <motion.button
                ...
                className="bg-white text-[#048c7f] hover:bg-gray-100 px-4 py-2 rounded-md flex items-center gap-2 font-medium"

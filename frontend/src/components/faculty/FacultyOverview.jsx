    ...
    try {
      ...
      if (courseFacultyMapping) {
        const courseResponse = await axios.get(
          `/api/courses/${courseFacultyMapping.courseId}`,
        );
      ...
      >
        <Card className="border-none shadow-xl mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Your current teaching schedule and progress
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            >
              {activeSemesters.length > 0 ? (
                activeSemesters.map((semester) => {
                  const completionPercentage = calculateSemesterCompletion(
                    semester.startDate,
                    semester.endDate,
                  );
                  ...
                  return (
                    ...
                    >
                      ...
                      <Progress
                        ...
                        className="h-2 bg-white [&>*]:bg-blue-500"
                      />

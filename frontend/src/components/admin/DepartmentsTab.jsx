  ...
  const handleAddDepartment = async () => {
    ...
    try {
      ...
      const errorMessage =
        ...
        "Failed to add department. Please check your connection and try again.";
  ...
  const handleUpdateDepartment = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `${apiUrl}/api/department/${currentDepartment._id}`,
        formData,
        config,
      );
      ...
      const errorMessage =
        err.response?.data?.message ||
        "Failed to update department. Please check your connection and try again.";
      setServerError(errorMessage);
      toast.error(errorMessage);
    } finally {
      setSubmitting(false);
  ...
  const openEditDialog = (department) => {
    ...
    setFormData({
      ...
      dateEstablished: department.dateEstablished
        ? department.dateEstablished.split("T")[0]
        : "",
    });
    setFormErrors({});
    setServerError(null);
                  ...
                  <AnimatePresence>
                    {departments.map((department, index) => (
                      ...
                      >
                        ...
                        <TableCell>
                          {formatDate(department.dateEstablished)}
                        </TableCell>
        ...
        <AlertDialogContent className="bg-white">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {currentDepartment?.name}". This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel

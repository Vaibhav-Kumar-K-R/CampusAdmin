  ...
  const fetchSemestersByDepartment = async (departmentId) => {
    try {
      ...
      const response = await axios.get(
        `${apiUrl}/api/semester/departmentId/${departmentId}`,
        config,
      );
      ...
      if (filterDepartment !== "all") {
        filteredStudents = filteredStudents.filter(
          (student) =>
            ...
            student.departmentId._id === filterDepartment,
        );
      }

      if (filterSemester !== "all") {
        filteredStudents = filteredStudents.filter(
          (student) => student.semesterId === filterSemester,
        );
      }

      if (filterSection !== "all") {
        filteredStudents = filteredStudents.filter(
          (student) => student.sectionId === filterSection,
        );
      }
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <p className="mt-1">
                    {currentStudent.departmentId
                      ? currentStudent.departmentId.name
                      : "N/A"}
                  </p>
                </div>
                <div>
                  ...
                  <p className="mt-1">
                    {getSemesterName(currentStudent.semesterId)}
                  </p>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-gray-500">Section</h3>
                  <p className="mt-1">
                    {getSectionName(currentStudent.sectionId)}
                  </p>
                </div>
              </div>
            </motion.div>
              ...
              <div className="grid gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Select
                    ...
                    disabled={
                      !formData.departmentId || filteredSemesters.length === 0
                    }
                  >
                    <SelectTrigger
                      className={`${formErrors.semesterId ? "border-red-500 ring-red-200" : ""} transition-all duration-200`}
                ...
                <div className="grid gap-2">
                  ...
                  <Select
                    ...
                    disabled={
                      !formData.semesterId || filteredSections.length === 0
                    }
                  >
                    <SelectTrigger
                      className={`${formErrors.sectionId ? "border-red-500 ring-red-200" : ""} transition-all duration-200`}
        ...
        <AlertDialogContent className="bg-white">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {currentStudent?.firstName} {currentStudent?.lastName}". This

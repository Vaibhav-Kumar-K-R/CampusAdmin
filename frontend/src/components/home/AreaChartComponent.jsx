          ...
          >
            ...
            <defs>
              <linearGradient id="fillGradient1" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#048c7f" stopOpacity={0.8} />
                <stop offset="95%" stopColor="#048c7f" stopOpacity={0.1} />
              </linearGradient>
      ...
      <CardFooter>
        <div className="flex w-full items-start gap-2 text-sm">
          <div className="grid gap-2">
            <div className="flex items-center gap-2 font-medium leading-none text-[#048c7f]">
